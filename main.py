...
class Game():
    def __init__(self):
        ...
        pygame.display.set_caption('Plane2D')
    ...
    def init_pic(self):
        self.help_image1 = pygame.image.load('images/help/help1.png') \
            .convert_alpha()
        self.help_image2 = pygame.image.load('images/help/help2.png') \
            .convert_alpha()
        self.back_image1 = pygame.image.load('images/help/back1.png') \
            .convert_alpha()
        self.back_image2 = pygame.image.load('images/help/back2.png') \
            .convert_alpha()
